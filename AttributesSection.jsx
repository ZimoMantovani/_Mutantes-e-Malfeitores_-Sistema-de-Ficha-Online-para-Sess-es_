...
import { ATTRIBUTES, calculateModifier, getRemainingPoints } from '../data/characterData';
  ...
  return (
    <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
      <div className="flex items-center gap-2 mb-6">
        <h2 className="text-xl font-bold text-gray-800">Atributos</h2>
        <InfoIcon content="Atributos custam 2 pontos por nível. Valores variam de 0 a 20. O modificador é calculado como (valor - 10) ÷ 2, arredondado para baixo." />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {ATTRIBUTES.map((attr) => {
          ...
          return (
            <div key={attr.key} className="border border-gray-200 rounded-lg p-4 bg-gray-50">
              <div className="text-center mb-3">
                <InfoTooltip 
                  content={`${attr.name}: Atributo fundamental que afeta várias perícias e capacidades. Custo atual: ${cost} pontos.`}
                  className="block"
                >
