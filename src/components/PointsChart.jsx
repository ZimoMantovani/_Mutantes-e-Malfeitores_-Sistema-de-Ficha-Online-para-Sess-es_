...
const PointsChart = () => {
  ...
  return (
    <div className="bg-card p-4 rounded-lg border shadow-sm">
      <h3 className="text-lg font-semibold mb-4 text-center text-foreground">Distribuição de Pontos</h3>
      ...
      <div className="space-y-2">
        <div className="flex justify-between items-center font-semibold text-lg border-t pt-2 text-foreground">
