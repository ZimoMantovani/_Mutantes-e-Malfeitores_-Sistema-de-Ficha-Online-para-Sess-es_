              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-3">
                  {ATTRIBUTES.map((attr) => {
                    ...
                    const modifier = value; // No M&M, o atributo é usado diretamente
                    ...
                    return (
                      ...
                      >
                        <div 
                          className="bg-muted p-3 rounded-lg text-center cursor-pointer hover:bg-muted/80 transition-colors"
